...
**floor** | **string** | Floor value | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesFloor200ResponseValuesInner } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesFloor200ResponseValuesInner = {
    datetime,
    floor,
};
```
