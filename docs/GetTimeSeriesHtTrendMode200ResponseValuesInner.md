...
**htTrendmode** | **string** | ht_trendmode value | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesHtTrendMode200ResponseValuesInner } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesHtTrendMode200ResponseValuesInner = {
    datetime,
    htTrendmode,
};
```
