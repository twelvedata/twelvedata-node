...
**tsf** | **string** | TSF value | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesTsf200ResponseValuesInner } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesTsf200ResponseValuesInner = {
    datetime,
    tsf,
};
```
