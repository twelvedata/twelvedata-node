...
**indicator** | [**GetTimeSeriesHtSine200ResponseMetaIndicator**](GetTimeSeriesHtSine200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesHtSine200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesHtSine200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
