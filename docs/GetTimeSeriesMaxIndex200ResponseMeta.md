...
**indicator** | [**GetTimeSeriesMaxIndex200ResponseMetaIndicator**](GetTimeSeriesMaxIndex200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesMaxIndex200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesMaxIndex200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
