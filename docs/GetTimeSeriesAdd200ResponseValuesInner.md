...
**add** | **string** | Add value | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesAdd200ResponseValuesInner } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesAdd200ResponseValuesInner = {
    datetime,
    add,
};
```
