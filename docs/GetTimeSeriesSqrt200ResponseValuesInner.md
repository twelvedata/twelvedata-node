...
**sqrt** | **string** | SQRT value | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesSqrt200ResponseValuesInner } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesSqrt200ResponseValuesInner = {
    datetime,
    sqrt,
};
```
