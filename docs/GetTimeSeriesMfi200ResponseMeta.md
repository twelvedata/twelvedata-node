...
**indicator** | [**GetTimeSeriesMfi200ResponseMetaIndicator**](GetTimeSeriesMfi200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesMfi200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesMfi200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
