...
**indicator** | [**GetTimeSeriesSuperTrend200ResponseMetaIndicator**](GetTimeSeriesSuperTrend200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesSuperTrend200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesSuperTrend200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
