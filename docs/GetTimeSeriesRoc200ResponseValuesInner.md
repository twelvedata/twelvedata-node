...
**roc** | **string** | roc value | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesRoc200ResponseValuesInner } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesRoc200ResponseValuesInner = {
    datetime,
    roc,
};
```
