...
**indicator** | [**GetTimeSeriesApo200ResponseMetaIndicator**](GetTimeSeriesApo200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesApo200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesApo200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
