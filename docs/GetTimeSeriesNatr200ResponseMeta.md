...
**indicator** | [**GetTimeSeriesNatr200ResponseMetaIndicator**](GetTimeSeriesNatr200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesNatr200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesNatr200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
