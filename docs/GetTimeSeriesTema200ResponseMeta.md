...
**indicator** | [**GetTimeSeriesTema200ResponseMetaIndicator**](GetTimeSeriesTema200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesTema200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesTema200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
