...
**indicator** | [**GetTimeSeriesDiv200ResponseMetaIndicator**](GetTimeSeriesDiv200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesDiv200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesDiv200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
