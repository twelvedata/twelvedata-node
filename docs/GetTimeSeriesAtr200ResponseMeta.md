...
**indicator** | [**GetTimeSeriesAtr200ResponseMetaIndicator**](GetTimeSeriesAtr200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesAtr200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesAtr200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
