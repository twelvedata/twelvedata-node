...
**indicator** | [**InlineObject11MetaIndicator**](InlineObject11MetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { InlineObject11Meta } from '@twelvedata/twelvedata-node';

const instance: InlineObject11Meta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
