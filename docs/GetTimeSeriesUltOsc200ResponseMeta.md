...
**indicator** | [**GetTimeSeriesUltOsc200ResponseMetaIndicator**](GetTimeSeriesUltOsc200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesUltOsc200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesUltOsc200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
