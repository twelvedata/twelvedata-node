...
**atr** | **string** | ATR value | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesAtr200ResponseValuesInner } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesAtr200ResponseValuesInner = {
    datetime,
    atr,
};
```
