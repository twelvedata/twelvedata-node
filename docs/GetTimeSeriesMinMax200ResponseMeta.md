...
**indicator** | [**GetTimeSeriesMinMax200ResponseMetaIndicator**](GetTimeSeriesMinMax200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesMinMax200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesMinMax200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
