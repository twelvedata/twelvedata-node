...
**indicator** | [**GetTimeSeriesStoch200ResponseMetaIndicator**](GetTimeSeriesStoch200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesStoch200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesStoch200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
