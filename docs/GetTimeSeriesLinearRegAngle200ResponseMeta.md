...
**indicator** | [**GetTimeSeriesLinearRegAngle200ResponseMetaIndicator**](GetTimeSeriesLinearRegAngle200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesLinearRegAngle200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesLinearRegAngle200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
