...
**indicator** | [**GetTimeSeriesSum200ResponseMetaIndicator**](GetTimeSeriesSum200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesSum200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesSum200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
