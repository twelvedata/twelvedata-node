...
**indicator** | [**GetTimeSeriesLog10200ResponseMetaIndicator**](GetTimeSeriesLog10200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesLog10200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesLog10200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
