...
**indicator** | [**GetTimeSeriesWillR200ResponseMetaIndicator**](GetTimeSeriesWillR200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesWillR200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesWillR200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
