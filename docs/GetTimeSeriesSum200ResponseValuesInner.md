...
**sum** | **string** | Sum value | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesSum200ResponseValuesInner } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesSum200ResponseValuesInner = {
    datetime,
    sum,
};
```
