...
**indicator** | [**GetTimeSeriesBeta200ResponseMetaIndicator**](GetTimeSeriesBeta200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesBeta200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesBeta200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
