...
**indicator** | [**GetTimeSeriesSar200ResponseMetaIndicator**](GetTimeSeriesSar200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesSar200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesSar200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
