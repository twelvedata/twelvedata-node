...
**indicator** | [**GetTimeSeriesRoc200ResponseMetaIndicator**](GetTimeSeriesRoc200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesRoc200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesRoc200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
