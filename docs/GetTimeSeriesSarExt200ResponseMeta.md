...
**indicator** | [**GetTimeSeriesSarExt200ResponseMetaIndicator**](GetTimeSeriesSarExt200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesSarExt200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesSarExt200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
