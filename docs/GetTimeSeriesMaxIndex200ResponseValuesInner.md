...
**maxidx** | **string** | maxidx value | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesMaxIndex200ResponseValuesInner } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesMaxIndex200ResponseValuesInner = {
    datetime,
    maxidx,
};
```
