...
**indicator** | [**GetTimeSeriesPivotPointsHL200ResponseMetaIndicator**](GetTimeSeriesPivotPointsHL200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesPivotPointsHL200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesPivotPointsHL200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
