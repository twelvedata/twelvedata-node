...
**indicator** | [**GetTimeSeriesMidPrice200ResponseMetaIndicator**](GetTimeSeriesMidPrice200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesMidPrice200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesMidPrice200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
