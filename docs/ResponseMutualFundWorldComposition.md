...
```typescript
import type { ResponseMutualFundWorldComposition } from '@twelvedata/twelvedata-node'
...
const exampleParsed = JSON.parse(exampleJSON) as ResponseMutualFundWorldComposition
