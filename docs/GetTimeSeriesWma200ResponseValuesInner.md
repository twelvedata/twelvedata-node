...
**wma** | **string** | WMA value | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesWma200ResponseValuesInner } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesWma200ResponseValuesInner = {
    datetime,
    wma,
};
```
