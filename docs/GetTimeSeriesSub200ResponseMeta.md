...
**indicator** | [**GetTimeSeriesSub200ResponseMetaIndicator**](GetTimeSeriesSub200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesSub200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesSub200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
