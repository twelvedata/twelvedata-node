...
**natr** | **string** | natr value | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesNatr200ResponseValuesInner } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesNatr200ResponseValuesInner = {
    datetime,
    natr,
};
```
