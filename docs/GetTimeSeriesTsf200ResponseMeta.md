...
**indicator** | [**GetTimeSeriesTsf200ResponseMetaIndicator**](GetTimeSeriesTsf200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesTsf200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesTsf200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
