...
**indicator** | [**GetTimeSeriesObv200ResponseMetaIndicator**](GetTimeSeriesObv200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesObv200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesObv200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
