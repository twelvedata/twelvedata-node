...
**indicator** | [**InlineObject14MetaIndicator**](InlineObject14MetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { InlineObject14Meta } from '@twelvedata/twelvedata-node';

const instance: InlineObject14Meta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
