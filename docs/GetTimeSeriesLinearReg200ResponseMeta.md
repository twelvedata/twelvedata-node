...
**indicator** | [**GetTimeSeriesLinearReg200ResponseMetaIndicator**](GetTimeSeriesLinearReg200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesLinearReg200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesLinearReg200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
