...
**indicator** | [**GetTimeSeriesDpo200ResponseMetaIndicator**](GetTimeSeriesDpo200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesDpo200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesDpo200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
