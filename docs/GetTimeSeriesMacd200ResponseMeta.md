...
**indicator** | [**GetTimeSeriesMacd200ResponseMetaIndicator**](GetTimeSeriesMacd200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesMacd200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesMacd200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
