...
**beta** | **string** | Beta value | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesBeta200ResponseValuesInner } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesBeta200ResponseValuesInner = {
    datetime,
    beta,
};
```
