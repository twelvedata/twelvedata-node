...
**indicator** | [**GetTimeSeriesExp200ResponseMetaIndicator**](GetTimeSeriesExp200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesExp200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesExp200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
