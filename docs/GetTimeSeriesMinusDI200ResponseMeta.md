...
**indicator** | [**GetTimeSeriesMinusDI200ResponseMetaIndicator**](GetTimeSeriesMinusDI200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesMinusDI200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesMinusDI200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
