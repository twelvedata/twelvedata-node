...
**stddev** | **string** | Standard Deviation value | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesStdDev200ResponseValuesInner } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesStdDev200ResponseValuesInner = {
    datetime,
    stddev,
};
```
