...
**rocr** | **string** | ROCR value | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesRocr200ResponseValuesInner } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesRocr200ResponseValuesInner = {
    datetime,
    rocr,
};
```
