...
**sma** | **string** | SMA value | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesSma200ResponseValuesInner } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesSma200ResponseValuesInner = {
    datetime,
    sma,
};
```
