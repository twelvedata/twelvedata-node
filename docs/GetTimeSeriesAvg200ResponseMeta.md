...
**indicator** | [**GetTimeSeriesAvg200ResponseMetaIndicator**](GetTimeSeriesAvg200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesAvg200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesAvg200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
