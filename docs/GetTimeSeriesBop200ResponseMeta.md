...
**indicator** | [**GetTimeSeriesBop200ResponseMetaIndicator**](GetTimeSeriesBop200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesBop200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesBop200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
