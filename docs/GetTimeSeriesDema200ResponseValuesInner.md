...
**dema** | **string** | Dema value | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesDema200ResponseValuesInner } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesDema200ResponseValuesInner = {
    datetime,
    dema,
};
```
