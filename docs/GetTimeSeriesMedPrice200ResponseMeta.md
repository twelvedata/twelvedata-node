...
**indicator** | [**GetTimeSeriesMedPrice200ResponseMetaIndicator**](GetTimeSeriesMedPrice200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesMedPrice200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesMedPrice200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
