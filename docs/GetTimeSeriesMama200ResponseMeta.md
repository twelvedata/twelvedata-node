...
**indicator** | [**GetTimeSeriesMama200ResponseMetaIndicator**](GetTimeSeriesMama200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesMama200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesMama200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
