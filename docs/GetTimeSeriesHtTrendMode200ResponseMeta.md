...
**indicator** | [**GetTimeSeriesHtTrendMode200ResponseMetaIndicator**](GetTimeSeriesHtTrendMode200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesHtTrendMode200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesHtTrendMode200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
