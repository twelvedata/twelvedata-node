...
**sarext** | **string** | SAREXT value | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesSarExt200ResponseValuesInner } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesSarExt200ResponseValuesInner = {
    datetime,
    sarext,
};
```
