...
```typescript
import { GetETFsWorld200ResponseEtfCompositionTopHoldingsInner } from '@twelvedata/twelvedata-node';

const instance: GetETFsWorld200ResponseEtfCompositionTopHoldingsInner = {
    symbol,
    name,
    exchange,
    micCode,
