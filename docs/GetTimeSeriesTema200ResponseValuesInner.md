...
**tema** | **string** | TEMA value | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesTema200ResponseValuesInner } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesTema200ResponseValuesInner = {
    datetime,
    tema,
};
```
