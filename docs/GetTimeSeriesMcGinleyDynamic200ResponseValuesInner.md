...
**mcginleyDynamic** | **string** | McGinley Dynamic value | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesMcGinleyDynamic200ResponseValuesInner } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesMcGinleyDynamic200ResponseValuesInner = {
    datetime,
    mcginleyDynamic,
};
```
