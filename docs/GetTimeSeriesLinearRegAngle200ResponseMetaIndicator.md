...
```typescript
import { GetTimeSeriesLinearRegAngle200ResponseMetaIndicator } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesLinearRegAngle200ResponseMetaIndicator = {
    name,
    seriesType,
    timePeriod,
};
