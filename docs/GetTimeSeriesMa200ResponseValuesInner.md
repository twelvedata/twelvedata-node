...
**ma** | **string** | MA value | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesMa200ResponseValuesInner } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesMa200ResponseValuesInner = {
    datetime,
    ma,
};
```
