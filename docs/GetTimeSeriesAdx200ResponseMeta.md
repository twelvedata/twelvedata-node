...
**indicator** | [**GetTimeSeriesAdx200ResponseMetaIndicator**](GetTimeSeriesAdx200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesAdx200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesAdx200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
