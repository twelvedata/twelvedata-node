...
**indicator** | [**InlineObject16MetaIndicator**](InlineObject16MetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { InlineObject16Meta } from '@twelvedata/twelvedata-node';

const instance: InlineObject16Meta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
