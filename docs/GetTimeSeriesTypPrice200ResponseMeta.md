...
**indicator** | [**GetTimeSeriesTypPrice200ResponseMetaIndicator**](GetTimeSeriesTypPrice200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesTypPrice200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesTypPrice200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
