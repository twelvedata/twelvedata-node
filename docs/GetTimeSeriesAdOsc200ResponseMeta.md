...
**indicator** | [**GetTimeSeriesAdOsc200ResponseMetaIndicator**](GetTimeSeriesAdOsc200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesAdOsc200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesAdOsc200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
