...
**indicator** | [**GetTimeSeriesVar200ResponseMetaIndicator**](GetTimeSeriesVar200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesVar200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesVar200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
