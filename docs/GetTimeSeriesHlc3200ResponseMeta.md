...
**indicator** | [**GetTimeSeriesHlc3200ResponseMetaIndicator**](GetTimeSeriesHlc3200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesHlc3200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesHlc3200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
