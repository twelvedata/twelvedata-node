...
```typescript
import type { GetETFsWorld200ResponseEtfComposition } from '@twelvedata/twelvedata-node'
...
const example = {
  ...
  "topHoldings": null,
  "bondBreakdown": null,
} satisfies GetETFsWorld200ResponseEtfComposition
...
const exampleParsed = JSON.parse(exampleJSON) as GetETFsWorld200ResponseEtfComposition
