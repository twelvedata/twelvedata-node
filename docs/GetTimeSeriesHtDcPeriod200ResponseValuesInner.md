...
**htDcperiod** | **string** | ht_dcperiod value | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesHtDcPeriod200ResponseValuesInner } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesHtDcPeriod200ResponseValuesInner = {
    datetime,
    htDcperiod,
};
```
