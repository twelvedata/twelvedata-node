...
```typescript
import { GetTimeSeriesLinearRegSlope200ResponseMetaIndicator } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesLinearRegSlope200ResponseMetaIndicator = {
    name,
    seriesType,
    timePeriod,
};
