...
**indicator** | [**GetTimeSeriesRocp200ResponseMetaIndicator**](GetTimeSeriesRocp200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesRocp200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesRocp200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
