...
**indicator** | [**InlineObject15MetaIndicator**](InlineObject15MetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { InlineObject15Meta } from '@twelvedata/twelvedata-node';

const instance: InlineObject15Meta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
