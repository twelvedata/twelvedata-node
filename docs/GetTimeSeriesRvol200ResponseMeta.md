...
**indicator** | [**GetTimeSeriesRvol200ResponseMetaIndicator**](GetTimeSeriesRvol200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesRvol200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesRvol200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
