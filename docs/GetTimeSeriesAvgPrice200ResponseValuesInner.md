...
**avgprice** | **string** | Avgprice value | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesAvgPrice200ResponseValuesInner } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesAvgPrice200ResponseValuesInner = {
    datetime,
    avgprice,
};
```
