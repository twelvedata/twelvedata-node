...
**indicator** | [**GetTimeSeriesMinusDM200ResponseMetaIndicator**](GetTimeSeriesMinusDM200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesMinusDM200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesMinusDM200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
