...
**indicator** | [**InlineObject13MetaIndicator**](InlineObject13MetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { InlineObject13Meta } from '@twelvedata/twelvedata-node';

const instance: InlineObject13Meta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
