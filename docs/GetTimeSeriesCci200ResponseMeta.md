...
**indicator** | [**GetTimeSeriesCci200ResponseMetaIndicator**](GetTimeSeriesCci200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesCci200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesCci200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
