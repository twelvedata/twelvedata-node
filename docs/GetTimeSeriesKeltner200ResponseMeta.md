...
**indicator** | [**GetTimeSeriesKeltner200ResponseMetaIndicator**](GetTimeSeriesKeltner200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesKeltner200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesKeltner200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
