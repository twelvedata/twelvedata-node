...
**indicator** | [**GetTimeSeriesTRange200ResponseMetaIndicator**](GetTimeSeriesTRange200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesTRange200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesTRange200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
