...
**indicator** | [**GetTimeSeriesDx200ResponseMetaIndicator**](GetTimeSeriesDx200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesDx200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesDx200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
