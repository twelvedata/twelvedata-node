...
------------ | ------------- | ------------- | -------------
**symbol** | **string** | Symbol of the instrument | [optional] [default to undefined]
...
```typescript
import { GetEarnings200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetEarnings200ResponseMeta = {
    symbol,
    name,
    currency,
    exchange,
