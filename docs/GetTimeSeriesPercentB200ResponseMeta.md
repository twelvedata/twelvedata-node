...
**indicator** | [**GetTimeSeriesPercentB200ResponseMetaIndicator**](GetTimeSeriesPercentB200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesPercentB200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesPercentB200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
