...
**indicator** | [**GetTimeSeriesCeil200ResponseMetaIndicator**](GetTimeSeriesCeil200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesCeil200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesCeil200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
