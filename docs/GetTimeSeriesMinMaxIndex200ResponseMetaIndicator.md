...
```typescript
import { GetTimeSeriesMinMaxIndex200ResponseMetaIndicator } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesMinMaxIndex200ResponseMetaIndicator = {
    name,
    seriesType,
    timePeriod,
};
