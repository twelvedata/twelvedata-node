...
**rvol** | **string** | RVOL value | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesRvol200ResponseValuesInner } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesRvol200ResponseValuesInner = {
    datetime,
    rvol,
};
```
