...
**indicator** | [**GetTimeSeriesMinIndex200ResponseMetaIndicator**](GetTimeSeriesMinIndex200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesMinIndex200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesMinIndex200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
