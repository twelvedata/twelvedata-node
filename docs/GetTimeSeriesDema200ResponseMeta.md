...
**indicator** | [**GetTimeSeriesDema200ResponseMetaIndicator**](GetTimeSeriesDema200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesDema200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesDema200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
