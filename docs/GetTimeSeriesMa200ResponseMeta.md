...
**indicator** | [**GetTimeSeriesMa200ResponseMetaIndicator**](GetTimeSeriesMa200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesMa200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesMa200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
