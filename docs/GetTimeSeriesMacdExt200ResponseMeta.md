...
**indicator** | [**GetTimeSeriesMacdExt200ResponseMetaIndicator**](GetTimeSeriesMacdExt200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesMacdExt200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesMacdExt200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
