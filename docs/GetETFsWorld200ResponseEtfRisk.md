...
```typescript
import type { GetETFsWorld200ResponseEtfRisk } from '@twelvedata/twelvedata-node'

// TODO: Update the object below with actual values
const example = {
  "volatilityMeasures": null,
  "valuationMetrics": null,
} satisfies GetETFsWorld200ResponseEtfRisk
...
const exampleParsed = JSON.parse(exampleJSON) as GetETFsWorld200ResponseEtfRisk
