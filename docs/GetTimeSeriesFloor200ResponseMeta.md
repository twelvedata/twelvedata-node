...
**indicator** | [**GetTimeSeriesFloor200ResponseMetaIndicator**](GetTimeSeriesFloor200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesFloor200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesFloor200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
