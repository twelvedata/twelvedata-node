...
**indicator** | [**GetTimeSeriesBBands200ResponseMetaIndicator**](GetTimeSeriesBBands200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesBBands200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesBBands200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
