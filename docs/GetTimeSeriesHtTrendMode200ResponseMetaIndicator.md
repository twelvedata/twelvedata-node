...
```typescript
import { GetTimeSeriesHtTrendMode200ResponseMetaIndicator } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesHtTrendMode200ResponseMetaIndicator = {
    name,
    seriesType,
};
```
