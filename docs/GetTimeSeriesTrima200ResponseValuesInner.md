...
**trima** | **string** | TRIMA value | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesTrima200ResponseValuesInner } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesTrima200ResponseValuesInner = {
    datetime,
    trima,
};
```
