...
**currency** | **string** | Currency of the instrument | [optional] [default to undefined]
...
```typescript
import { GetStatistics200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetStatistics200ResponseMeta = {
    symbol,
    name,
    currency,
    exchange,
