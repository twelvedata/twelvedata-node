...
```typescript
import { GetTimeSeriesMcGinleyDynamic200ResponseMetaIndicator } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesMcGinleyDynamic200ResponseMetaIndicator = {
    name,
    timePeriod,
};
```
