...
**indicator** | [**GetTimeSeriesStochRsi200ResponseMetaIndicator**](GetTimeSeriesStochRsi200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesStochRsi200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesStochRsi200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
