...
**asin** | **string** | ASIN value | [optional] [default to undefined]

## Example

```typescript
import { InlineObject9ValuesInner } from '@twelvedata/twelvedata-node';

const instance: InlineObject9ValuesInner = {
    datetime,
    asin,
};
```
