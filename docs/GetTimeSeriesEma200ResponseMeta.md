...
**indicator** | [**GetTimeSeriesEma200ResponseMetaIndicator**](GetTimeSeriesEma200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesEma200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesEma200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
