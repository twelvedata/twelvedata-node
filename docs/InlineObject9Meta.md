...
**indicator** | [**InlineObject9MetaIndicator**](InlineObject9MetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { InlineObject9Meta } from '@twelvedata/twelvedata-node';

const instance: InlineObject9Meta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
