...
**indicator** | [**GetTimeSeriesMom200ResponseMetaIndicator**](GetTimeSeriesMom200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesMom200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesMom200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
