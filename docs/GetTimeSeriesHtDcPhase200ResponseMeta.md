...
**indicator** | [**GetTimeSeriesHtDcPhase200ResponseMetaIndicator**](GetTimeSeriesHtDcPhase200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesHtDcPhase200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesHtDcPhase200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
