...
```typescript
import { GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner } from '@twelvedata/twelvedata-node';

const instance: GetETFsWorld200ResponseEtfRiskVolatilityMeasuresInner = {
    period,
    alpha,
    alphaCategory,
    beta,
