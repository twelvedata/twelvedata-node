...
**ad** | **string** | AD value | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesAd200ResponseValuesInner } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesAd200ResponseValuesInner = {
    datetime,
    ad,
};
```
