...
**indicator** | [**InlineObject8MetaIndicator**](InlineObject8MetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { InlineObject8Meta } from '@twelvedata/twelvedata-node';

const instance: InlineObject8Meta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
