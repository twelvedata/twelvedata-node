...
**indicator** | [**GetTimeSeriesPlusDM200ResponseMetaIndicator**](GetTimeSeriesPlusDM200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesPlusDM200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesPlusDM200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
