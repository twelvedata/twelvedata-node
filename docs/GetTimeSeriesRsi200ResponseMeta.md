...
**indicator** | [**GetTimeSeriesRsi200ResponseMetaIndicator**](GetTimeSeriesRsi200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesRsi200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesRsi200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
