...
**mfi** | **string** | MFI value | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesMfi200ResponseValuesInner } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesMfi200ResponseValuesInner = {
    datetime,
    mfi,
};
```
