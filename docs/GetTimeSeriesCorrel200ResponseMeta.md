...
**indicator** | [**GetTimeSeriesCorrel200ResponseMetaIndicator**](GetTimeSeriesCorrel200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesCorrel200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesCorrel200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
