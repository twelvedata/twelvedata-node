...
**indicator** | [**GetTimeSeriesMult200ResponseMetaIndicator**](GetTimeSeriesMult200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesMult200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesMult200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
