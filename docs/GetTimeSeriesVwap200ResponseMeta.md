...
**indicator** | [**GetTimeSeriesVwap200ResponseMetaIndicator**](GetTimeSeriesVwap200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesVwap200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesVwap200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
