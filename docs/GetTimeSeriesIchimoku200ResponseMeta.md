...
**indicator** | [**GetTimeSeriesIchimoku200ResponseMetaIndicator**](GetTimeSeriesIchimoku200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesIchimoku200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesIchimoku200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
