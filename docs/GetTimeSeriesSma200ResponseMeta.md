...
**indicator** | [**GetTimeSeriesSma200ResponseMetaIndicator**](GetTimeSeriesSma200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesSma200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesSma200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
