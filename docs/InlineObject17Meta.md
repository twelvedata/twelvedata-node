...
**indicator** | [**InlineObject17MetaIndicator**](InlineObject17MetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { InlineObject17Meta } from '@twelvedata/twelvedata-node';

const instance: InlineObject17Meta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
