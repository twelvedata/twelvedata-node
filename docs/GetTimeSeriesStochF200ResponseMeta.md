...
**indicator** | [**GetTimeSeriesStochF200ResponseMetaIndicator**](GetTimeSeriesStochF200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesStochF200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesStochF200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
