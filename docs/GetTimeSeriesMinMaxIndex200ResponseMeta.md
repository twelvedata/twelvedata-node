...
**indicator** | [**GetTimeSeriesMinMaxIndex200ResponseMetaIndicator**](GetTimeSeriesMinMaxIndex200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesMinMaxIndex200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesMinMaxIndex200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
