...
**bop** | **string** | Bop value | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesBop200ResponseValuesInner } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesBop200ResponseValuesInner = {
    datetime,
    bop,
};
```
