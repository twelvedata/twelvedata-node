...
**typprice** | **string** | typprice value | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesTypPrice200ResponseValuesInner } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesTypPrice200ResponseValuesInner = {
    datetime,
    typprice,
};
```
