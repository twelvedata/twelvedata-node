...
**indicator** | [**GetTimeSeriesKama200ResponseMetaIndicator**](GetTimeSeriesKama200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesKama200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesKama200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
