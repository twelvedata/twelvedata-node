...
**indicator** | [**GetTimeSeriesMidPoint200ResponseMetaIndicator**](GetTimeSeriesMidPoint200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesMidPoint200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesMidPoint200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
