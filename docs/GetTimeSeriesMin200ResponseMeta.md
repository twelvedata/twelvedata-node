...
**indicator** | [**GetTimeSeriesMin200ResponseMetaIndicator**](GetTimeSeriesMin200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesMin200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesMin200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
