...
**htDcphase** | **string** | HT_DCPHASE value | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesHtDcPhase200ResponseValuesInner } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesHtDcPhase200ResponseValuesInner = {
    datetime,
    htDcphase,
};
```
