...
**indicator** | [**GetTimeSeriesCoppock200ResponseMetaIndicator**](GetTimeSeriesCoppock200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesCoppock200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesCoppock200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
