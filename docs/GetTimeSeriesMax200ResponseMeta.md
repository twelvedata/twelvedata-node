...
**indicator** | [**GetTimeSeriesMax200ResponseMetaIndicator**](GetTimeSeriesMax200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesMax200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesMax200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
