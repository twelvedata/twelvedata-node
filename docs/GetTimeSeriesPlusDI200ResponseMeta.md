...
**indicator** | [**GetTimeSeriesPlusDI200ResponseMetaIndicator**](GetTimeSeriesPlusDI200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesPlusDI200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesPlusDI200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
