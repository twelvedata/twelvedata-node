...
**indicator** | [**InlineObject12MetaIndicator**](InlineObject12MetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { InlineObject12Meta } from '@twelvedata/twelvedata-node';

const instance: InlineObject12Meta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
