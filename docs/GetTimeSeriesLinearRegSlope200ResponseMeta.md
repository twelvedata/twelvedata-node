...
**indicator** | [**GetTimeSeriesLinearRegSlope200ResponseMetaIndicator**](GetTimeSeriesLinearRegSlope200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesLinearRegSlope200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesLinearRegSlope200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
