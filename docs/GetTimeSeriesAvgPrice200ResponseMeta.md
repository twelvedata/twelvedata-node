...
**indicator** | [**GetTimeSeriesAvgPrice200ResponseMetaIndicator**](GetTimeSeriesAvgPrice200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesAvgPrice200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesAvgPrice200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
