...
**indicator** | [**GetTimeSeriesHeikinashiCandles200ResponseMetaIndicator**](GetTimeSeriesHeikinashiCandles200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesHeikinashiCandles200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesHeikinashiCandles200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
