...
**indicator** | [**GetTimeSeriesTrima200ResponseMetaIndicator**](GetTimeSeriesTrima200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesTrima200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesTrima200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
