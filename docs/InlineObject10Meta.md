...
**indicator** | [**InlineObject10MetaIndicator**](InlineObject10MetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { InlineObject10Meta } from '@twelvedata/twelvedata-node';

const instance: InlineObject10Meta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
