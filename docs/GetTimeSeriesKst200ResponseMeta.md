...
**indicator** | [**GetTimeSeriesKst200ResponseMetaIndicator**](GetTimeSeriesKst200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesKst200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesKst200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
