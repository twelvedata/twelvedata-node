...
**indicator** | [**GetTimeSeriesWclPrice200ResponseMetaIndicator**](GetTimeSeriesWclPrice200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesWclPrice200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesWclPrice200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
