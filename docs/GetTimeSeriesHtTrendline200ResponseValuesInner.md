...
**htTrendline** | **string** | HT_TRENDLINE value | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesHtTrendline200ResponseValuesInner } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesHtTrendline200ResponseValuesInner = {
    datetime,
    htTrendline,
};
```
