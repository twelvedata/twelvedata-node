...
**indicator** | [**GetTimeSeriesLinearRegIntercept200ResponseMetaIndicator**](GetTimeSeriesLinearRegIntercept200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesLinearRegIntercept200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesLinearRegIntercept200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
