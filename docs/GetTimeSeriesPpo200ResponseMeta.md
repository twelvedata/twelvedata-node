...
**indicator** | [**GetTimeSeriesPpo200ResponseMetaIndicator**](GetTimeSeriesPpo200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesPpo200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesPpo200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
