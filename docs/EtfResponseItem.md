...
**name** | **string** | Full name of the ETF | [optional] [default to undefined]
**currency** | **string** | Currency of the ETF according to the ISO 4217 standard | [optional] [default to undefined]
**exchange** | **string** | Exchange where the ETF is traded | [optional] [default to undefined]
**micCode** | **string** | Market identifier code (MIC) under ISO 10383 standard | [optional] [default to undefined]
**country** | **string** | Country where the ETF is located | [optional] [default to undefined]
...
```typescript
import { EtfResponseItem } from '@twelvedata/twelvedata-node';

const instance: EtfResponseItem = {
    symbol,
    name,
    currency,
    exchange,
