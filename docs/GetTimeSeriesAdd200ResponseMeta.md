...
**indicator** | [**GetTimeSeriesAdd200ResponseMetaIndicator**](GetTimeSeriesAdd200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesAdd200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesAdd200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
