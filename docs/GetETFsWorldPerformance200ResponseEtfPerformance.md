...
```typescript
import { GetETFsWorldPerformance200ResponseEtfPerformance } from '@twelvedata/twelvedata-node';

const instance: GetETFsWorldPerformance200ResponseEtfPerformance = {
    trailingReturns,
    annualTotalReturns,
};
```
