...
**indicator** | [**GetTimeSeriesCmo200ResponseMetaIndicator**](GetTimeSeriesCmo200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesCmo200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesCmo200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
