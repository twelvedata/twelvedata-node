...
**indicator** | [**GetTimeSeriesWma200ResponseMetaIndicator**](GetTimeSeriesWma200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesWma200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesWma200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
