...
**indicator** | [**GetTimeSeriesAdxr200ResponseMetaIndicator**](GetTimeSeriesAdxr200ResponseMetaIndicator.md) |  | [optional] [default to undefined]

## Example

```typescript
import { GetTimeSeriesAdxr200ResponseMeta } from '@twelvedata/twelvedata-node';

const instance: GetTimeSeriesAdxr200ResponseMeta = {
    symbol,
    interval,
    currency,
    exchangeTimezone,
