...
export function instanceOfEndpointEnum(value: any): boolean {
  for (const key in EndpointEnum) {
    if (Object.prototype.hasOwnProperty.call(EndpointEnum, key)) {
      if (EndpointEnum[key as keyof typeof EndpointEnum] === value) {
        return true;
      }
    }
  }
...
export function EndpointEnumFromJSON(json: any): EndpointEnum {
  return EndpointEnumFromJSONTyped(json, false);
}

export function EndpointEnumFromJSONTyped(
  json: any,
  ignoreDiscriminator: boolean,
): EndpointEnum {
  return json as EndpointEnum;
}

export function EndpointEnumToJSON(value?: EndpointEnum | null): any {
  return value as any;
}

export function EndpointEnumToJSONTyped(
  value: any,
  ignoreDiscriminator: boolean,
): EndpointEnum {
  return value as EndpointEnum;
}
