...
export function GetTimeSeriesStoch200ResponseMetaIndicatorFromJSONTyped(
  ...
  return {
    ...
    slowKPeriod:
      json["slow_k_period"] == null ? undefined : json["slow_k_period"],
    slowDPeriod:
      json["slow_d_period"] == null ? undefined : json["slow_d_period"],
    slowKmaType:
      json["slow_kma_type"] == null ? undefined : json["slow_kma_type"],
    slowDmaType:
      json["slow_dma_type"] == null ? undefined : json["slow_dma_type"],
  };
}
