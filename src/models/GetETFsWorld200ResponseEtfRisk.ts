 ...
 * @export
 * @interface GetETFsWorld200ResponseEtfRisk
 */
export interface GetETFsWorld200ResponseEtfRisk {
   ...
   * @memberof GetETFsWorld200ResponseEtfRisk
   */
...
/**
 * Check if a given object implements the GetETFsWorld200ResponseEtfRisk interface.
 */
export function instanceOfGetETFsWorld200ResponseEtfRisk(
  value: object,
): value is GetETFsWorld200ResponseEtfRisk {
  return true;
}

export function GetETFsWorld200ResponseEtfRiskFromJSON(
  json: any,
): GetETFsWorld200ResponseEtfRisk {
  return GetETFsWorld200ResponseEtfRiskFromJSONTyped(json, false);
}

export function GetETFsWorld200ResponseEtfRiskFromJSONTyped(
  json: any,
...
export function GetETFsWorld200ResponseEtfRiskToJSON(
  json: any,
): GetETFsWorld200ResponseEtfRisk {
  return GetETFsWorld200ResponseEtfRiskToJSONTyped(json, false);
}

export function GetETFsWorld200ResponseEtfRiskToJSONTyped(
  value?: GetETFsWorld200ResponseEtfRisk | null,
