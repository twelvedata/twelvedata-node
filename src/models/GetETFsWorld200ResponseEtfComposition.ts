 ...
 * @export
 * @interface GetETFsWorld200ResponseEtfComposition
 */
export interface GetETFsWorld200ResponseEtfComposition {
   ...
   * @memberof GetETFsWorld200ResponseEtfComposition
   */
...
/**
 * Check if a given object implements the GetETFsWorld200ResponseEtfComposition interface.
 */
export function instanceOfGetETFsWorld200ResponseEtfComposition(
  value: object,
): value is GetETFsWorld200ResponseEtfComposition {
  return true;
}

export function GetETFsWorld200ResponseEtfCompositionFromJSON(
  json: any,
): GetETFsWorld200ResponseEtfComposition {
  return GetETFsWorld200ResponseEtfCompositionFromJSONTyped(json, false);
}

export function GetETFsWorld200ResponseEtfCompositionFromJSONTyped(
  json: any,
...
export function GetETFsWorld200ResponseEtfCompositionToJSON(
  json: any,
): GetETFsWorld200ResponseEtfComposition {
  return GetETFsWorld200ResponseEtfCompositionToJSONTyped(json, false);
}

export function GetETFsWorld200ResponseEtfCompositionToJSONTyped(
  value?: GetETFsWorld200ResponseEtfComposition | null,
