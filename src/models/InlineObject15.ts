...
export function InlineObject15FromJSONTyped(
  ...
  return {
    meta:
      json["meta"] == null
        ? undefined
        : InlineObject15MetaFromJSON(json["meta"]),
    values:
      json["values"] == null
        ? undefined
        : (json["values"] as Array<any>).map(InlineObject15ValuesInnerFromJSON),
...
export function InlineObject15ToJSONTyped(
  ...
  return {
    ...
    values:
      value["values"] == null
        ? undefined
        : (value["values"] as Array<any>).map(InlineObject15ValuesInnerToJSON),
    status: value["status"],
  };
}
